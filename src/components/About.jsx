...
const About = () => {
  ...
  return (
      <section id='about' className='snap-start h-screen'>
          ...
          <a className="border border-[#F7ab0a] hover:bg-transparent py-3 text-[1rem] font-semibold px-6 hover:text-[#F7ab0a] rounded-lg bg-[#F7ab0a] text-white transition duration-[.2s] " onClick={handleClick} rel="noopener noreferrer" download>
       Download CV
      </a>
          </div>
                </motion.div> 
